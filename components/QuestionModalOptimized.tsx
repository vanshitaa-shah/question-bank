...
// Optimized Textarea component using React 19's ref as prop
function OptimizedTextarea(props: React.ComponentProps<"textarea"> & { ref?: React.Ref<HTMLTextAreaElement> }) {
...
export default function QuestionModal({
  ...
  // React 19: Optimistic updates for form submission
  ...
  // Reset form and clear errors when modal state changes
  useEffect(() => {
    if (!isOpen) {
  ...
  const handleSubmit = async (formData: FormData) => {
    try {
      ...
      // Close modal on success for add mode
      if (mode === "add") {
        onOpenChange(false);
      }
    } catch (error) {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <OptimizedTextarea
                  ...
                  required
                  minLength={10}
                  aria-describedby="question-error question-hint"
                />
              ...
              <div className="space-y-2">
                ...
                <OptimizedTextarea
                  ...
                  required
                  minLength={5}
                  aria-describedby="answer-error answer-hint"
                />
